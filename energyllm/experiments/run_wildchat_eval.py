...
PPO_V5_DIR = os.path.join(PROPOSED_DIR, "ablation/wo_token_aware")
...
VLLM_MODEL_PATH = "/home/data/models/Meta-Llama-3.1-8B-Instruct"
PPO_MODEL_PATH = os.path.join(PPO_V5_DIR, "checkpoints/ppo_final.pt")

LATENCY_MODEL_PATH = os.path.join(PROPOSED_DIR, "results/latency_model.joblib")
POWER_MODEL_PATH = os.path.join(PROPOSED_DIR, "results/power_model.joblib")
MODEL_META_PATH = os.path.join(PROPOSED_DIR, "results/model_meta.joblib")

OUTPUT_DIR = os.path.join(BASE_DIR, "generalization/wildchat_results")
...
def generate_summary(results, output_dir, timestamp):
    ...
    print("\n" + "="*80)
    print("WildChat Dataset Test Results Summary (Average)")
    print("="*80)
...
if __name__ == '__main__':
    ...
    parser = argparse.ArgumentParser(description='WildChat dataset generalization test')
    ...
    print("="*60)
    print("WildChat Dataset Generalization Test")
    print("="*60)
