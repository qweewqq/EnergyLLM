...
class RLScheduler:
    ...
    def __init__(self, model_path, slo_latency_sec, dataset_path=None, arrival_rate=0.8):
        ...
        print(f"Scheduler initialized: SLO={slo_latency_sec}s")
    ...
    def _load_ml_models(self):
        try:
            ...
            print(f"Warning: Unable to load ML models: {e}")
    ...
    def run_simulation(self, duration_sec, arrival_rate):
        self.arrival_rate = arrival_rate
        print(f"\nStarting simulation: {duration_sec}s, {arrival_rate} req/s, SLO={self.slo_latency_sec}s")
    ...
    def _print_stats(self):
        ...
        print("\n" + "=" * 50)
        print(f"SLO Satisfaction Rate: {satisfied/total*100:.2f}%")
        print(f"Average Latency: {df['e2e_latency'].mean():.2f}s")
        print(f"Average Energy: {energy/total:.2f} J/req")
