"""
消融实验: Fixed Freq (1200MHz) - Qwen2.5-7B版本
基于 wo_token_aware，固定频率，只调整批次大小
"""
...
RL_DIR = os.path.join(BASE_DIR, "ablation_qwen25_7b/fixed_freq")
...
# ============================================
FIXED_FREQ = 1200
FIXED_FREQ_IDX = FREQ_OPTIONS.index(FIXED_FREQ)  # 索引8

# 状态空间（与 wo_token_aware 相同）
STATE_DIM = 7

# 动作空间: 只有批次选择 = 7
ACTION_DIM = len(BATCH_OPTIONS)  # 7
