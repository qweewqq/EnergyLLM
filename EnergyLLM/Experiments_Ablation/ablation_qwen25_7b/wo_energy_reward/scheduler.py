"""
消融实验调度器: w/o Energy Reward - Qwen2.5-7B版本
与 wo_token_aware/scheduler.py 完全相同
"""
...
class RLScheduler:
    """消融实验调度器: w/o Energy Reward (Qwen2.5-7B)"""
    ...
    def __init__(self, model_path, slo_latency_sec, dataset_path=None, arrival_rate=0.8):
        ...
        print(f"[Qwen2.5-7B] 消融调度器 (w/o Energy Reward): SLO={slo_latency_sec}s")
