"""
消融实验: w/o Energy Reward - Qwen2.5-7B版本
基于 wo_token_aware，去掉能耗奖励
"""
...
RL_DIR = os.path.join(BASE_DIR, "ablation_qwen25_7b/wo_energy_reward")
...
# 动作空间（与 wo_token_aware 相同）
NUM_FREQS = len(FREQ_OPTIONS)
NUM_BATCHES = len(BATCH_OPTIONS)
...
REWARD_CONFIG = {
    ...
    'energy_weight': 0.0,        # 消融: 去掉能耗惩罚
    'low_energy_bonus': 0.0,     # 消融: 去掉低能耗奖励
