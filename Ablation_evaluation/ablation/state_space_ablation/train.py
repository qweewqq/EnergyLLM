"""
消融实验训练脚本: w/o SLO & Latency Features
去掉 recent_slo 和 recent_latency 特征，验证历史性能指标的价值
状态空间从 7 维减少到 5 维
"""
...
def train(agent, total_timesteps, eval_freq=10000, save_freq=100000):
    """PPO 强化学习训练"""
    print("\n" + "=" * 60)
    print("消融实验: w/o SLO & Latency Features")
    print("去掉 recent_slo 和 recent_latency，验证历史性能指标的价值")
    print("状态维度: 7 → 5")
    print("=" * 60)
...
def main():
    ...
    print(f"状态维度: 5 (去掉 recent_slo, recent_latency)")
    print("=" * 60)
