...
去掉 recent_slo 和 recent_latency 特征
状态空间从 7 维减少到 5 维
"""
...
RL_DIR = os.path.join(BASE_DIR, "ablation_v2/state_space_ablation")
...
# ============================================
# 消融: 去掉 recent_slo 和 recent_latency 特征
# 状态空间从 7 维减少到 5 维
# ============================================
STATE_DIM = 5  # 消融: 去掉 recent_slo, recent_latency
