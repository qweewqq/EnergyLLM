"""
消融实验: w/o SLO & Latency Features
去掉 recent_slo 和 recent_latency 特征，状态空间从 7 维减少到 5 维
"""
...
class LLMSchedulingEnv(gym.Env):
    """消融: w/o SLO & Latency Features（5 维状态）"""
    ...
    def __init__(self, slo_target=DEFAULT_SLO, arrival_rate=0.8, randomize_config=False):
        ...
        # ============================================
        # 消融: 5 维状态空间（去掉 recent_slo, recent_latency）
        # ============================================
    ...
    def _get_state(self):
        """
        消融: 5 维状态（去掉 recent_slo, recent_latency）
...
if __name__ == '__main__':
    ...
    for ep in range(3):
        ...
        print(f"State dim: {len(state)}, State: {state}")
